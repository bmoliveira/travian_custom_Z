...
$database->mysql_query_adapter("UPDATE ".TB_PREFIX."medal set del = 1 WHERE id = ".$medalid."");
...
$database->mysql_query_adapter("UPDATE ".TB_PREFIX."medal set del = 1 WHERE week = ".$deleteweek."");
